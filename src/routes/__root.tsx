...
function RootDocument({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="font-sans antialiased [overflow-wrap:anywhere] selection:bg-[color-mix(in_oklab,var(--foreground)_18%,transparent)] selection:text-[var(--background)]">
        {isChromelessRoute ? null : <Header />}
        {children}
